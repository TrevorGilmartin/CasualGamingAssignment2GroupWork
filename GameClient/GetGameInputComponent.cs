...
namespace GameClient
{
    ...
    class GetGameInputComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            sfont = Game.Content.Load<SpriteFont>(@"OtherAssets\keyboardfont");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if(!firstText)
                spriteBatch.DrawString(sfont, "Tag Name" + Output, new Vector2(100, GraphicsDevice.Viewport.Height - 150), Color.Red);
            else spriteBatch.DrawString(sfont, "Password" + Output, new Vector2(100, GraphicsDevice.Viewport.Height - 150), Color.Red);
